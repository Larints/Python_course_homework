...
print('Привет, сыграем в "Scrabble" введи слово: ')
...
first_letter_dict = {'A': 1, 'E': 1, 'I': 1, 'O': 1,
                     'U': 1, 'L': 1, 'N': 1, 'S': 1,
                     'T': 1, 'R': 1, 'D': 2, 'G': 2,
                     'B': 3, 'C': 3, 'M': 3, 'P': 3,
                     'F': 4, 'H': 4, 'V': 4, 'W': 4,
...
second_letter_dict = {'А': 1, 'В': 1, 'Е': 1, 'И': 1,
                      'Н': 1, 'О': 1, 'Р': 1, 'С': 1,
                      'Т': 1, 'Д': 2, 'К': 2, 'Л': 2,
                      'М': 2, 'П': 2, 'У': 2, 'Б': 3,
                      'Г': 3, 'Ё': 3, 'Ь': 3, 'Я': 3,
...
for i in word:
    if i in first_letter_dict.keys():
        result += first_letter_dict[i]
    elif i in second_letter_dict.keys():
        result += second_letter_dict[i]
